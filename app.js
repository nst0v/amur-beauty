(() => {
  ...
  $$('dialog').forEach(dialog => {
    ...
    // A backdrop click closes the dialog. Clicking its interior does not.
    ...
    dialog.addEventListener('close', () => {
      ...
      if (restoreFocus && document.contains(restoreFocus) && !$('dialog[open]')) {
  ...
  function showImage(index) {
    ...
    picture.onload = () => {
      if (version === loadVersion) lightbox.classList.remove('is-loading');
    };
    picture.onerror = () => {
